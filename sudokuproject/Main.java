...
public class Main {
    ...
    final JLabel timerLabel = new JLabel("Time Remaining:");
    final JButton startButton = new JButton("Begin");
    final JButton submitButton = new JButton("Check");
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    frame.setTitle("Sudoku by Mamadou");
    ...
    private void initialize() {
        timer.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                timeCount--;
                timerLabel.setText("Time Remain- "+countToTime(timeCount));
        ...
        JLabel difficultyLabel = new JLabel("Select level:");
        ...
        final JRadioButton easyButton = new JRadioButton("level 1:Easy");
        ...
        final JRadioButton mediumButton = new JRadioButton("level 2:Medium");
        ...
        final JRadioButton hardButton = new JRadioButton("level 3:Hard");
        ...
        startButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                if(isStarted){
                    ...
                    startButton.setText("Show solution!");
